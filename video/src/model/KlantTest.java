...
public class KlantTest {
	...
	public void testToString() {
		  Klant k3 = new Klant(1,"Dave");
		  assertEquals("id: "+3+" || Achternaam: "+"Dave"+" || Adres: "+"null"+
		    " || Woonplaats: "+"null"+" || Postcode: "+"null"+
		    "\nTelefoonnummer: "+"null"+" || gebortedatum: "+"null", k3.toString());
		  
		  assertNotSame("id: "+4+" || Achternaam: "+"Dave"+" || Adres: "+"null"+
		    " || Woonplaats: "+"null"+" || Postcode: "+"null"+
		    "\nTelefoonnummer: "+"null"+" || gebortedatum: "+"null", k3.toString());
